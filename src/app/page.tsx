  ...
  return (
    <div className="bg-slate-100">
      <section>
        ...
        >
          <div className="col-span-2 px-6 lg:px-0 lg:pt-32">
            <div
              className="mx-auto text-center lg:text-left
              flex flex-col items-center lg:items-start"
            >
              <div className="absolute w-28 left-15 top-20 hidden lg:block">
                <img src="/snake-1.png" className="w-full" alt="snake" />
              </div>
              <h1
                className="relative w-fit tracking-tight text-balance font-bold
              ...
              <p className="mt-6 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                ViperVault allows you to protect your memories ,not just your
                phone case.
              </p>
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            <img src="/snake-2.png" alt="snake" className="w-24 lg:order-2" />
          </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Vijay Verma</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  phone case. This one, besides barely noticeble scratchmarks on
                  the corner,{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    looks brank new after about half a year
                  </span>
                  ,I dig it.
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Ajay Chaudhary</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="w-4 h-4 stroke-[3px] text-green-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
      ...
      <section className="">
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div
              className="relative flex items-center flex-col md:grid
              grid-cols-2 gap-40"
            >
              <img
                src="/arrow.png"
              ...
              md:justify-self-end mx-w-sm rounded-xl bg-gray-900/5 
